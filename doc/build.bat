:: -----------------------------------------------------------------
:: File:   build.bat
:: Author: (c) 2025 Jens Kallup - paule32 & fibonacci
:: All rights reserved
::
...
doxygen.exe Doxyfile.Server.chm.ini >nul 2>nul
...
::dot.exe -Tpng .\doc\dot\datentypen.dot -o .\doc\dot\img\datentypen.png
...
copy .\dox\chm\devdoc.chm .\devdoc.chm
